...
<div id="services" class="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white">
    <div class="container xl:max-w-6xl mx-auto px-4">
        <header class="text-center mx-auto mb-12 lg:px-20">
            <h2 class="text-2xl leading-normal mb-2 font-bold text-black uppercase">Formations</h2>
        ...
        <div class="flex flex-wrap flex-row -mx-4 text-center">
            <div class="visible animate-fadeInUp duration-1000 flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" >
                <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Licence    </h3>
                    <h3 class="text-lg leading-normal mb-2 font-semibold text-black"> Systèmes Informatiques</h3>
